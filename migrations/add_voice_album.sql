...
-- aligned snippet; append-only; NEVER a ranking term (the quorum bonus
...
COMMENT ON TABLE public.voice_album IS
  'Album entries: acoustic emphasize + user approved + coach strong (published). Append-only capture (SPEC F2 / founder 2026-08-14).';
