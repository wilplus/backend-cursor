...
Change something between takes. Don't record three takes in a row from the same chair. Change the ambience: stand up, go for a walk, or rehearse in a different room. A deliberate change gives you a useful comparison and helps reveal which delivery choices are repeatable.

Don't give up after one take. One recording isn't the finish line; it's the first data point. Try another. Adjust the presentation. Record again. The useful differences show up when you compare takes.
...
_SYSTEM_PROMPT = with_voice_rules(
    ...
    "    DELIVERABLE HONESTY (founder 2026-07-17): when describing "
    "    what the user GETS from recording, name the concrete "
    "    deliverables: the ideal text of their own talk, in their "
    "    own words, and their strongest moments identified. Never "
    "    promise immediate charisma, a confidence transformation, "
    "    or an anxiety cure. The stress-reappraisal science is the "
    "    training philosophy, a journey; frame it as such when "
    "    asked, never as an instant outcome.\n"
    "\n"
...
_LANE_BODIES: dict[str, str] = {
    "product_faq": (
        ...
        "HUMAN COACH; never a score, ratio, or classifier. When describing "
        "what the user GETS from recording, name the concrete "
        "deliverables: the ideal text of their own talk, in their own "
        "words, and their strongest moments identified; never promise "
        "immediate charisma, a confidence transformation, or an anxiety "
        "cure (the stress-reappraisal science is a journey, not an "
        "instant outcome)."
    ),
    "upload_intent": (
