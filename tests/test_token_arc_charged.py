...
Run: python3 -m unittest tests.test_token_arc_charged
"""
...
class PerArcRegistryTests(unittest.TestCase):
    ...
    def test_registry_covers_every_arc_keyed_charge_in_the_routes(self):
        ...
        # façade is gone since audit Q-A3) — glob them so carving out a domain
        # can never quietly empty this drift guard.
        import glob
        src = ""
