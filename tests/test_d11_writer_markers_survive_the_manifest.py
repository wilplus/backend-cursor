...
Production lost both preambles.  0362 re-injects them.
...
and purpose rows D11 reads, so 0363 gives it v1's preamble.
"""
...
#: 0357 creates v2 without a preamble; 0363 injects v1's.
...
class D11WriterMarkersSurviveTheManifest(unittest.TestCase):
    ...
    def test_0363_injects_exactly_the_registered_v2_spec(self):
    ...
    def test_without_0363_the_walk_names_0357(self):
        # v2 is created unmarked; only 0363 closes it.
    ...
    def test_0363_follows_0357(self):
        files = manifest_files()
        self.assertGreater(files.index(V2_CLOSURE), files.index(OPTIONAL_YES))

    def test_0363_restates_the_service_role_grant_by_exact_signature(self):
    ...
    def test_0362_restates_the_service_role_grants_by_exact_signature(self):
