...
Run: python3 -m unittest tests.test_ideal_decision_ledger
"""
...
from services.ideal_decision_ledger import frozen_approved_replacement
...
# ── merged from tests/test_ledger_acceptance_freeze.py (audit Q-T9) ──
