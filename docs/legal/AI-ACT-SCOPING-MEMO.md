...
| Terms §7 prohibits employer and educational use | Live text: `src/app/terms/page.tsx:306` in `wilplus/frontend-cursor` at commit `f460788` — pinned, because that page is edited under this pack. Draft replacement: `legal/phase1-2026.1/copy/terms-2.0-DRAFT.txt:123`. |
