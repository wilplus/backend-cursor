...
`services/coach_video_storage.py:112` and `:164`,
...
`resolve_targets` is all-or-nothing by design — *"Unknown inventory means zero
deletion"*, `services/data_purge.py:720`. A dependency that cannot resolve a
