...
> discovery. A separate discrepancy is unresolved and is NOT estimated here:
> `user_settings` holds 7 rows while 25 distinct user identifiers have audio.
> Both figures are recorded as they came back.
>
