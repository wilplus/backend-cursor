    ...
    with out_path.open("w", encoding="utf-8") as fh:
        for row in rows:
            ...
            item = {
                ...
                "split_group_key": row.get("user_id") or row.get("session_id") or row.get("recording_id"),
                ...
                "labeled_by_admin_id": row.get("labeled_by_admin_id") or row.get("labeled_by"),
                "labeled_by_admin_email": row.get("labeled_by_admin_email"),
