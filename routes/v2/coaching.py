"""The conversational surface: /chat/* and /coaching/*.

The chat query + session state, the coaching turn and the 9-step state
machine, and the intro bubble. The onboarding dad-joke opener and the
interview question-generation module (routes/v2/user_chat.py) were
deleted in Phase 6 (audit Q-A7): no frontend caller, retired by the
founder. Several prompts here are drift-tracked in place by
