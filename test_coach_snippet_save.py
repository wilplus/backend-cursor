...
The response echoes the persisted canonical coach_state. Note/tag/surfaced
remain the user-facing coach-authoring contract.
...
class PerSnippetSaveTests(unittest.TestCase):
    ...
    def test_snippet_not_in_session_404(self):
        status, _ = self._call({"note": "x"}, snip=OTHER_SNIP)
