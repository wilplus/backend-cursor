...
CREATE TABLE IF NOT EXISTS recording_sessions (
  ...
  recording_id UUID,  -- FK added below after recordings exists
  abandon_reason TEXT,
...
-- FK from v2_sessions.report_id to v2_reports (after report_id column exists)
DO $$ BEGIN
...
-- Pre-recording questions seed (if empty)
